...
GOOGLE_API_KEY = "AIzaSyDRHNysKQODSlLX5ErrfczfYsljkljryg4"
db_user = "postgres"
...
prompt_template = """
Given an input question, create a syntactically correct PostgreSQL query to run. Do not include any markdown formatting or backticks in your response. Only provide the raw SQL query.
